        ...
        <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-interval="10">
                    <img src="assets/images/slider_1.jpg" class="d-block w-100" alt="black">
                </div>
                <div class="carousel-item" data-interval="10">
                    <img src="assets/images/lisaa.png" class="d-block w-100" alt="lisa">
                </div>
                <div class="carousel-item">
                    <img src="assets/images/black.png" class="d-block w-100" alt="black">
                </div>
            </div>
            <div class="carousel-item">
                <img src="assets/images/slider_1.jpg" class="d-block w-100" alt="slider">
            </div>
        </div>
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-interval="5">
                <img src="assets/images/black.jpg" class="d-block w-100" alt="black">
            </div>
            <div class="carousel-item" data-interval="15">
                <img src="assets/images/lisa.jpg" class="d-block w-100" alt="lisa">
            </div>
            <div class="carousel-item" data-interval="5">
                <img src="assets/images/bts.jpg" class="d-block w-100" alt="bts">
            </div>
        </div>
    </div>
    <a class="carousel-control-prev" href="#carouselExampleInterval" role="button" data-slide="prev">
                        ...
                        <div class="product-item <?php echo e($product->category_id); ?> ">
                            <div class="product discount product_filter">
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="product_price"><?php echo e(number_format($product->product_price)); ?>

                                        ₺<span><?php echo e(number_format($product->original_price )); ?>
