    ...
    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 image_col order-lg-2 order-1">
                        <div class="single_product_image">
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="single_product_image_background" style="background-image:url('<?php echo asset("
        ...
        <div class="col-lg-5">
            <div class="product_details">
                ...
                <div class="product_pric"> No. Hp : <?php echo e(($product->phone)); ?> </div>
                <div class="product_price"> Alamat : <?php echo e(($product->address)); ?> </div>
